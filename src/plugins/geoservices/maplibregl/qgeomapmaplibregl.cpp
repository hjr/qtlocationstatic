...
void QGeoMapMaplibreGL::copyrightsChangedHandler(const QString &copyrightsHtml)
{
    ...
    // TODO: Perhaps we could remote this at all? MapLibre should generate the whole text itself.
    if (d->m_activeMapType.name().startsWith("mapbox://")) {
        ...
        copyrightsHtmlFinal = "<table><tr><th><img src='qrc:/maplibregl/logo.png'/></th><th>"
